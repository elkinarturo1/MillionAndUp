...
namespace MillionAndUp.BL.V1.Services.Security
{
    public class BasicAuthHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            {
                return AuthenticateResult.Fail("La peticion no tiene credenciales de autenticacion");
            }
            ...
            try
            {
                ...
                result = _userService.CredentialsValidation(email, pass);
            }
            catch
            {
                return AuthenticateResult.Fail("Ocurrio algo en la autenticacion! ");
            }
